...
Name of the File : a3_a1.cpp

This program uses pointer to store the address, the value, make pointer to
point to variables we created, using swap function() to swap the contents of the 
integers arguements, and swap the address of the elements too. The output would 
show the content switched up.  
...
int main() {
    ...
    *p2 = temp;
    ...
    cout << "#20:  The first  element in a[] is " << *p1
        << " and the second element in a[] is " << *p2 << endl;
    ...
    swap(a, &a[1]);
    cout << "#23:  Now, a[0] contains: " << a[0] << " and a[1] contains: "
        << a[1] << endl;
...
#17:  The address of the first element is 0113FE60
#18:  The address of the second element is 0113FE64
...
(process 13636) exited with code 0.
